...
enum VibeType {
  ...
  VibeHyphen = 34,
  VibeSlash = 35,
  VibeOpenParentheses = 37,
  VibeCloseParentheses = 38,
  VibeQuotes = 39,
  VibeAt = 40,
  VibeEquals = 41,
};
...
int breakvibe = 350;
  ...
  switch (packet->type) {
    ...
    case VibeA: {
      static const uint32_t const segments[] = { dot, breakvibe, dash };
      VibePattern pat = {
        .durations = segments,
    ...
    case VibeB: {
      static const uint32_t const segments[] = { dash, breakvibe, dot,breakvibe,dot,breakvibe,dot };
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeC: {
      static const uint32_t const segments[] = { dash, breakvibe, dot,breakvibe,dash,breakvibe,dot };
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeD: {
      static const uint32_t const segments[] = { dash, breakvibe, dot,breakvibe,dot };
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeE: {
      static const uint32_t const segments[] = { dot };
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeF: {
      static const uint32_t const segments[] = { dot,breakvibe,dot,breakvibe,dash,breakvibe,dot };
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeG: {
      static const uint32_t const segments[] = { dash,breakvibe,dash,breakvibe,dot };
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeH: {
      static const uint32_t const segments[] = { dot,breakvibe,dot,breakvibe,dot,breakvibe,dot };
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeI: {
      static const uint32_t const segments[] = { dot,breakvibe,dot};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeJ: {
      static const uint32_t const segments[] = { dot,breakvibe,dash,breakvibe,dash,breakvibe,dash };
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeK: {
      static const uint32_t const segments[] = { dash,breakvibe,dot,breakvibe,dash };
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeL: {
      static const uint32_t const segments[] = { dot,breakvibe,dash,breakvibe,dot,breakvibe,dot};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeM: {
      static const uint32_t const segments[] = { dash,breakvibe,dash,breakvibe };
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeN: {
      static const uint32_t const segments[] = { dash,breakvibe,dot };
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeO: {
      static const uint32_t const segments[] = { dash,breakvibe,dash,breakvibe,dash };
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeP: {
      static const uint32_t const segments[] = { dot,breakvibe,dash,breakvibe,dash,breakvibe,dot };
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeQ: {
      static const uint32_t const segments[] = { dash,breakvibe,dash,breakvibe,dot,breakvibe,dash };
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeR: {
      static const uint32_t const segments[] = { dot,breakvibe,dash,breakvibe,dot};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeS: {
      static const uint32_t const segments[] = { dot,breakvibe,dot,breakvibe,dot};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeT: {
      static const uint32_t const segments[] = { dash};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeU: {
      static const uint32_t const segments[] = { dot,breakvibe,dot,breakvibe,dash};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeV: {
      static const uint32_t const segments[] = { dot,breakvibe,dot,breakvibe,dot,breakvibe,dash};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeW: {
      static const uint32_t const segments[] = { dot,breakvibe,dash,breakvibe,dash};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeX: {
      static const uint32_t const segments[] = { dash,breakvibe,dot,breakvibe,dot,breakvibe,dash};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeY: {
      static const uint32_t const segments[] = { dash,breakvibe,dot,breakvibe,dash,breakvibe,dash};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeZ: {
      static const uint32_t const segments[] = { dash,breakvibe,dash,breakvibe,dot,breakvibe,dot};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibePeriod: {
      static const uint32_t const segments[] = { dot,breakvibe,dash,breakvibe,dot,breakvibe,dash,breakvibe,dot,breakvibe,dash};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeComma: {
      static const uint32_t const segments[] = { dash,breakvibe,dash,breakvibe,dot,breakvibe,dot,breakvibe,dash,breakvibe,dash};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeColon: {
      static const uint32_t const segments[] = { dash,breakvibe,dash,breakvibe,dash,breakvibe,dot,breakvibe,dot,breakvibe,dot};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeQuestion: {
      static const uint32_t const segments[] = { dot,breakvibe,dot,breakvibe,dash,breakvibe,dash,breakvibe,dot,breakvibe,dot};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeHyphen: {
      static const uint32_t const segments[] = { dash,breakvibe,dot,breakvibe,dot,breakvibe,dot,breakvibe,dot,breakvibe,dash};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeSlash: {
      static const uint32_t const segments[] = { dash,breakvibe,dot,breakvibe,dot,breakvibe,dash,breakvibe,dot};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeOpenParentheses: {
      static const uint32_t const segments[] = { dash,breakvibe,dot,breakvibe,dash,breakvibe,dash,breakvibe,dot,breakvibe,dash};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeQuotes: {
      static const uint32_t const segments[] = { dot,breakvibe,dash,breakvibe,dot,breakvibe,dot,breakvibe,dash,breakvibe,dot};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
    ...
    case VibeAt: {
      static const uint32_t const segments[] = { dot,breakvibe,dash,breakvibe,dash,breakvibe,dot,breakvibe,dash,breakvibe,dot};
      VibePattern pat = {
        .durations = segments,
        .num_segments = ARRAY_LENGTH(segments),
      };
